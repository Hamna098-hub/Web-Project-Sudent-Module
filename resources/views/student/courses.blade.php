...
<div class="card">
    <div class="card-header text-white fw-bold d-flex justify-content-between align-items-center"
        ...
        <a href="{{ route('student.my-enrollments') }}" class="btn btn-light btn-sm">
    ...
    <div class="card-body">
        @if($courses->isEmpty())
            <div class="text-center py-5">
                ...
                <h5 class="text-muted">You are enrolled in all available courses!</h5>
                <a href="{{ route('student.my-enrollments') }}" class="btn btn-primary mt-2">
                    View My Enrollments
                </a>
            </div>
        @else
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST"
                                      action="{{ route('student.enroll', $course->id) }}">
                                    @csrf
