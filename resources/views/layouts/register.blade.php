...
<head>
    ...
    <style>
        ...
        .form-control:focus, .form-select:focus { box-shadow: 0 0 0 3px rgba(27,94,32,0.2); border-color: #2e7d32; }
    </style>
</head>
<body>
<div class="container">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('student.register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="student_name" class="form-control" placeholder="Enter your full name" value="{{ old('student_name') }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="phone" class="form-control" placeholder="e.g. 03001234567" value="{{ old('phone') }}" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="text-center">
                        <p class="mb-0">Already have an account? <a href="{{ route('student.login') }}" class="text-success fw-bold">Login Here</a></p>
                    </div>
                </div>
            </div>
        </div>
